...
#define LORA_BANDWIDTH 250   // Bandwidth in kHz (125, 250, or 500)
#define LORA_SPREADING_FACTOR 7 // Spreading factor (7-12)
#define LORA_CODING_RATE 6     // Coding rate denominator (5-8)
...
#define CLEANUP_INTERVAL 40000 // Interval to remove stale nodes in ms
#define NEIGHBOUR_TIMEOUT 30000 // Timeout for neighbor nodes in ms
#endif