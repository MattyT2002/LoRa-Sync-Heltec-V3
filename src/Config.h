...
#define LORA_BANDWIDTH 500     // Bandwidth in kHz (125, 250, or 500)
...
#define CLEANUP_INTERVAL 600000 // Interval to remove stale nodes in ms
#define NEIGHBOUR_TIMEOUT 300000 // Timeout for neighbor nodes in ms
#endif